...
export const atelier: AtelierConfig = {
  ...
  owner: 'Lena Wegmann',
  shortBio:
    'Näh-Atelier für Bergsport-Reparaturen in Grindelwald — Daune, Hardshell, Rucksäcke, Zelte. Reparieren statt wegwerfen.',
  bio: [
    'Ich bin Lena, gelernte Bekleidungstechnikerin, Bergsteigerin und seit fünfzehn Jahren mit der Industrienähmaschine vertraut. Nach Stationen in einer Outdoor-Manufaktur im Tessin und drei Jahren als Schneiderin bei einem Bergführerbüro in Grindelwald habe ich 2022 das Atelier Gipfelnaht eröffnet.',
  ...
  location: {
    ...
    canton: 'BE',
    postalCode: '3818',
    street: 'Dorfstrasse 88',
    address: 'Dorfstrasse 88, 3818 Grindelwald',
    ...
    routeUrl:
      'https://www.openstreetmap.org/?mlat=46.6244&mlon=8.0411#map=16/46.6244/8.0411',
  },
  contact: {
    email: 'hallo@gipfelnaht.ch',
    phone: '+41338531234',
    phoneDisplay: '+41 33 853 12 34',
